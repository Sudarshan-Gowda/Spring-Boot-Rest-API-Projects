...
COMMENT ON COLUMN "RESEARCH"."EMPLOYEE"."DATE_OF_BIRTH" IS 'Employee Date of Birth';
...
GRANT SELECT, INSERT, UPDATE , DELETE ON RESEARCH.EMPLOYEE TO RESEARCH;
GRANT SELECT, INSERT, UPDATE , DELETE ON RESEARCH.ADDRESS_DETAIL TO RESEARCH;
...
GRANT SELECT ON RESEARCH.EMPLOYEE_ID_SEQ TO RESEARCH;
GRANT SELECT ON RESEARCH.ADDRESS_DETAIL_ID_SEQ TO RESEARCH;
GRANT SELECT ON RESEARCH.PROJECT_ID_SEQ TO RESEARCH;
