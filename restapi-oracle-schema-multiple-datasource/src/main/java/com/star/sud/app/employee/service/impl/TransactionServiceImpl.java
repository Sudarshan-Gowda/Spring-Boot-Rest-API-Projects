package com.star.sud.app.employee.service.impl;
...
import com.star.sud.app.employee.controller.TransactionController;
import com.star.sud.app.employee.dto.AddressDetailDto;
import com.star.sud.app.employee.dto.EmployeeDto;
import com.star.sud.app.employee.dto.ProjectsDto;
...
import com.star.sud.app.employee.repository.EmployeeRepository;
import com.star.sud.app.employee.repository.ProjectsRepository;
import com.star.sud.app.employee.service.ITransactionService;
...
@Service
@Transactional("firstTrasactionManager")
public class TransactionServiceImpl implements ITransactionService {
	...
	public ResponseEntity<?> updateEmployeeById(String empId, @Valid EmployeeDto request)
		...
		employee.setDob(DateUtil.getDateFromString(request.getDob()));
