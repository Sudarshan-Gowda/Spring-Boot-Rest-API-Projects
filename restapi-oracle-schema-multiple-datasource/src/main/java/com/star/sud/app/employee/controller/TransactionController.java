package com.star.sud.app.employee.controller;
...
public class TransactionController {
	...
	public ResponseEntity<?> deleteEmployeeById(@PathVariable String empId) throws Exception {
		log.info("TransactionController.deleteEmployeeById()");
		return service.deleteEmployeeById(empId);

	}

	@PutMapping(value = "/employee/{empId}")
	public ResponseEntity<?> updateEmployeeById(@PathVariable String empId, @RequestBody @Valid EmployeeDto request)
			throws Exception {
		log.info("TransactionController.updateEmployeeById()");
		return service.updateEmployeeById(empId, request);
