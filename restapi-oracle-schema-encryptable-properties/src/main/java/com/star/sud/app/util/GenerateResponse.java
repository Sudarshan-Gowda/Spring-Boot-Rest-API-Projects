...
public class GenerateResponse {
	...
	public static <T> ResponseDTO<T> getIntServErrorResp(String errorDetails) {
		...
		responseDTO
				.setError(getError(ErrorCode.EC002.getCode(), ErrorCode.EC002.getDescription(), errorDetails, "ERROR"));
	...
	public static <T> ResponseDTO<T> getBadReqErrorResp(String errorDetails) {
		...
		responseDTO
				.setError(getError(ErrorCode.EC001.getCode(), ErrorCode.EC001.getDescription(), errorDetails, "ERROR"));
